    ...
    <div class="ibm-container-body">
        <table class="ibm-data-table ibm-altrows ibm-padding-small" data-scrollaxis="x" data-info="true" data-ordering="true" data-paging="true" data-searching="true" data-widget="datatable" id="{{ $name }}">
            ...
            <tbody>
                ...
                <tr>
                    <td>
                    <p class="ibm-ind-link ibm-icononly ibm-nospacing"><a class="ibm-edit-link" href="#">This is a icon-only</a></p>
                    </td>
                    ...
                    <td>
                    <p class="ibm-ind-link ibm-icononly ibm-nospacing"><a class="ibm-remove-link" href="#">This is a icon-only</a></p>
                    </td>                    
                </tr>
                @endforeach
            </tbody>
