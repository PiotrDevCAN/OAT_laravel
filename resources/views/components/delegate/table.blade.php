            ...
            <tbody>
                ...
                <tr>
                    ...
                    @isset($record->user_intranet)
                    	{{ link_to_route('admin.delegate.edit', $title = '', ['user_intranet' => Str::of($record->user_intranet)->trim(), 'delegate_intranet' => Str::of($record->delegate_intranet)->trim()], ['class' => 'ibm-edit-link']) }}
                    @endisset
                    </p></td>
