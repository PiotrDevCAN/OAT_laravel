<div data-widget="showhide" data-type="panel" class="ibm-show-hide ibm-alternate">
    ...
    <div class="ibm-container-body">
        <table class="ibm-data-table ibm-altrows ibm-small" data-scrollaxis="x" data-info="true" data-ordering="true" data-paging="true" data-searching="true" data-widget="datatable" id="{{ $name }}">
            <thead>
                <tr>
