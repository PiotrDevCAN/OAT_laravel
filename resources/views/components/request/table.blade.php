<div data-widget="showhide" data-type="panel" class="ibm-show-hide ibm-alternate">
    ...
    <div class="ibm-container-body">
        <table class="ibm-data-table ibm-altrows ibm-padding-small ibm-small" data-serverSide="true" data-ajax="xhr.php" data-scrollaxis="x" data-info="true" data-ordering="true" data-paging="true" data-searching="true" data-widget="datatable" id="{{ $name }}">
            <thead>
                <tr>
