			...
			switch(tabletDataObject.widget){
				case 'datatableReady':
					...
					tabletDataObject.columns = [
						...
						{ data: 'hours' },
						{ data: 'status' },
						{ data: 'approver_first_level', render: '1st Level Approval' },
						{ data: 'approver_second_level', render: '2nd Level Approval' },
						{ data: 'approver_third_level', render: '3rd Level Approval' },
						{ data: 'requestor' },
						{ data: 'approval_mode' },
