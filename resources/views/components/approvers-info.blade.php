...
<td align='center'>
    ...
    @endempty
    @empty(!$lvl1Line2)
    	<p class="ibm-padding-bottom-0">{{ $lvl1Line2 }}</p>
    @endempty
    @empty(!$lvl1Line3)
    	<p class="ibm-padding-bottom-0">{{ $lvl1Line3 }}</p>
    @endempty
    @empty(!$lvl1Line4)
...
<td align='center'>
    ...
    @endempty
    @empty(!$lvl2Line2)
    	<p class="ibm-padding-bottom-0">{{ $lvl2Line2 }}</p>
    @endempty
    @empty(!$lvl2Line3)
    	<p class="ibm-padding-bottom-0">{{ $lvl2Line3 }}</p>
    @endempty
    @empty(!$lvl2Line4)
...
<td align='center'>
    ...
    @endempty
    @empty(!$lvl3Line2)
    	<p class="ibm-padding-bottom-0">{{ $lvl3Line2 }}</p>
    @endempty
    @empty(!$lvl3Line3)
    	<p class="ibm-padding-bottom-0">{{ $lvl3Line3 }}</p>
    @endempty
    @empty(!$lvl3Line4)
